...
- **Spring Boot REST API Demo**  
  JWT auth, PostgreSQL, CI/CD, Angular frontend  
  👉 https://github.com/manooweb/springboot-rest-api-demo

- **Java Foundations**  
  Modern Java fundamentals, Maven, testing  
  👉 https://github.com/manooweb/java-foundations

- **Java CLI Data Tool**  
  Lightweight CLI tool using Picocli + Jackson  
  👉 https://github.com/manooweb/java-cli-data-tool

## 🛠 Tech Stack

Java · Spring Boot · Angular · REST · PostgreSQL · Docker · GitHub Actions · Linux
